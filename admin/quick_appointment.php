...
$servicesStmt = $pdo->prepare('SELECT id, name, duration_minutes, deposit_ars FROM services WHERE business_id=:bid AND is_active=1 ORDER BY id');
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
  ...
  try {
    ...
    // Nota: la tabla appointments ya no tiene columnas payment_status/deposit_ars.
